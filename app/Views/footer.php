        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                ...
                <p class="site-footer-muted">
                    The UK marketplace to discover event suppliers, request structured quotes and manage bookings—from weddings and christenings to birthdays and corporate occasions.
                </p>
                <p class="footer-script">P.S. leave the planning to us.</p>
            </div>
