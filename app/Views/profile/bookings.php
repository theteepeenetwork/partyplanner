            ...
            <tbody>
                <?php foreach ($bookingItems as $item): ?>
                    <tr>
                        ...
                        <td>
                            <span
                                class="badge badge-pill <?= $item['status'] == 'accepted' ? 'badge-success' : ($item['status'] == 'pending' ? 'badge-warning' : 'badge-danger') ?>">
                                <?= ucfirst($item['status']) ?>
                            </span>
                        </td>
                        <td>
                            <form method="POST"
                                action="<?= base_url('profile/update-booking-status/' . $item['booking_item_id']) ?>">
                                <?= csrf_field() ?>
                        ...
                        <td>
                            <a href="<?= base_url('chat/start/' . $item['customer_id'] . '/' . $item['service_id']) ?>"
                                class="chat-icon">
