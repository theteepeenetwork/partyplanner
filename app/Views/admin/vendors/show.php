<div class="admin-toolbar d-flex justify-content-between align-items-center flex-wrap">
    <h1 class="admin-page-title mb-0">Vendor #<?= (int) $user['id'] ?></h1>
    <div class="btn-group">
...
<div class="row g-3">
    ...
    <div class="col-md-8">
        <div class="card shadow-sm admin-table-card mb-3">
            <div class="card-header bg-white fw-semibold">Services</div>
        ...
        <div class="card shadow-sm admin-table-card mb-3">
            <div class="card-header bg-white fw-semibold">Bookings (via services)</div>
            <div class="table-responsive">
                <table class="table table-sm mb-0 align-middle">
