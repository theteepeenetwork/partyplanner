...
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — component map, quote pipeline, pricing model matrix, payment flow, auth model, CLI commands
- [docs/API_REFERENCE.md](docs/API_REFERENCE.md) — public API for the five core Library classes
- [CONTRIBUTING.md](CONTRIBUTING.md) — branching, commits, testing, linting
